...
namespace QZCHY.Services.Helpers
{
    /// <summary>
    /// User agent helper
    /// </summary>
    ...
    {
        private readonly QZCHYConfig _config;
        ...
        public UserAgentHelper(QZCHYConfig config, IWebHelper webHelper, HttpContextBase httpContext)
        {
            this._config = config;
