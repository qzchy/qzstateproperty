...
namespace QZCHY.Core.Infrastructure
{
    ...
    /// Engine
    /// </summary>
    public class QZCHYEngine : IEngine
    {
        #region Fields
        ...
        protected virtual void RegisterDependencies(QZCHYConfig config, HttpConfiguration httpConfig)
        {
            ...
            builder.RegisterInstance(config).As<QZCHYConfig>().SingleInstance();
        ...
        /// </summary>
        /// <param name="config">Config</param>
        public void Initialize(QZCHYConfig config,HttpConfiguration httpConfig)
        {
