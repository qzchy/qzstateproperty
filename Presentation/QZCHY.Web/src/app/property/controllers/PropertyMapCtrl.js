...
app.controller("PropertyMapCtrl", ['$scope', '$rootScope', '$state',
    function ($scope, $rootScope, $state) {
        ...
        if ($scope.Property.Lon != undefined && $scope.Property.Lat != undefined)
            $scope.setMarker($scope.Property.Lon, $scope.Property.Lat);
        else
            $scope.$watch("Property", function (oldValue, newValue) {
                if ($scope.Property.Lon != undefined && $scope.Property.Lat != undefined)
                    $scope.setMarker($scope.Property.Lon, $scope.Property.Lat);
            }, true);
