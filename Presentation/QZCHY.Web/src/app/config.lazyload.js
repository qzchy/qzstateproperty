/// <reference path="../vendor/modules/angular-bootstrap-datetimepicker/js/datetimepicker.js" />
/// <reference path="../vendor/modules/angular-kindeditor/kindeditor/kindeditor-all-min.js" />
...
angular.module('app')
  ...
  .constant('JQ_CONFIG', {
      ...
      dataTable: ['vendor/jquery/datatables/jquery.dataTables.js',
      ...
      daterangepicker: ['vendor/jquery/daterangepicker/daterangepicker.js',
                          'vendor/jquery/daterangepicker/daterangepicker.css']
  }
  )
  // oclazyload config
      ...
      $ocLazyLoadProvider.config({
          ...
          modules: [
              ...
              },
              {
                  name: 'ngKeditor',
                  files: [
                      'vendor/modules/angular-kindeditor/kindeditor/kindeditor-all-min.js',
                      'vendor/modules/angular-kindeditor/angular-kindeditor.min.js'
                  ]
              },
              {
                  name: 'ngTagsInput',
                  files: [
                      'vendor/modules/ng-tags-input/ng-tags-input.css',
                      'vendor/modules/ng-tags-input/ng-tags-input.bootstrap.css',
                      'vendor/modules/ng-tags-input/ng-tags-input.js'
                  ]
              },
              {
                  name: 'angular-nicescroll',
                  files: [
                      'vendor/modules/nicescroll/jquery.nicescroll.js',
                      'vendor/modules/nicescroll/angular-nicescroll.js'
                  ]
              },
              {
                  name: 'infinite-scroll',
                  files: [
                      'vendor/modules/ng-infinite/ng-infinite-scroll.min.js'
                  ]
              },
              {
                  name: 'fancyboxplus',
                  files: [
                      'vendor/modules/fancybox/css/jquery.fancybox-plus.css',
                      'vendor/modules/fancybox/jquery.fancybox-plus.min.js',
                      'vendor/modules/fancybox/angular-fancybox-plus.js'
                  ]
              }
          ]
      });
