...
namespace QZCHY.Web.Framework.Menu
{
    public class XmlSiteMap
    {
        ...
        private static void PopulateNode(SiteMapNode siteMapNode, XmlNode xmlNode)
        {
            ...
            //title
            //var QZCHYResource = GetStringValueFromAttribute(xmlNode, "QZCHYResource");
            ...
            if (!string.IsNullOrEmpty(controllerName) && !string.IsNullOrEmpty(actionName))
            {
                ...
                //apply admin area as described here - http://www.QZCHYcommerce.com/boards/t/20478/broken-menus-in-admin-area-whilst-trying-to-make-a-plugin-admin-page.aspx
